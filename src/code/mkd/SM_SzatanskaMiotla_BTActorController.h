...
class SM_SzatanskaMiotla_BTActorController : public IActorController {
public:
    explicit SM_SzatanskaMiotla_BTActorController(ActorAI* ai);
    ~SM_SzatanskaMiotla_BTActorController();
